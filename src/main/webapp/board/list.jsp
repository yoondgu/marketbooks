                    ...
                    <div class="page_aticle">
                                <div id="snb" class="snb_cc">
                                    ...
                                    <div class="inner_snb">
                                        <ul class="list_menu">
                                            <li class="on">
                                             <a href="/marketbooks/board/list.jsp">공지사항</a>
                                            </li>
                                            <li>
                                                <a href="/marketbooks/board/faq.jsp">자주하는 질문</a>
                                            </li>
                                            <li>
                                                <a href="/marketbooks/board/inquiry.jsp">1:1 문의</a>
                                            </li>
                                        </ul>
                                    </div>
                                ...
                                <div class="page_section">
                                    ...
                                    <a href="view.php?id=notice&amp;no=1591"><b>[마켓컬리] KURLY BIRTH WEEK 럭키기프트 이벤트 당첨 안내</b></a><b>
                                    </b></td>
                                    ...
                                    공지 </td>
                                    <td style="padding-left:10px; text-align:left; color:#999">
                                    <a href="view.php?id=notice&amp;no=64"><b>마켓컬리 배송 안내</b></a><b>
                                    </b></td>
                                    <td width="100" nowrap="" align="center">
                                    MarketKurly </td>
                                    ...
                                    공지 </td>
                                    <td style="padding-left:10px; text-align:left; color:#999">
                                    <a href="view.php?id=notice&amp;no=931"><b>[마켓컬리] 포장재 회수 서비스 안내</b></a><b>
                                    </b></td>
                                    <td width="100" nowrap="" align="center">
                                    MarketKurly </td>
                                    ...
                                    <div class="layout-pagination">
                                        <div class="pagediv">
                                            <a href="list.php?id=notice&amp;page=1" class="layout-pagination-button layout-pagination-first-page">맨 처음 페이지로 가기</a>
                                            <a href="list.php?id=notice&amp;page=1" class="layout-pagination-button layout-pagination-prev-page">이전 페이지로 가기</a>
                                            ...
                                            <a href="list.php?id=notice&amp;page=145" class="layout-pagination-button layout-pagination-last-page">맨 끝 페이지로 가기</a>
                                        </div>
                                    </div>
                                    ...
                                    <table class="xans-board-search xans-board-search2">
                                        <tbody>
                                            ...
                                            <td>
                                            <div class="search_bt">
                                            <a href="javascript:document.frmList.submit()"><img src="../images/search.jpeg" align="absmiddle"></a>
